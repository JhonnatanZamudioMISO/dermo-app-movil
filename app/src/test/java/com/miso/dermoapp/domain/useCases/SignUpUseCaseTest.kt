...
class SignUpUseCaseTest {
    ...
    @Test
    fun `Caso 03`() {
        val result = signUpUseCase.changeEnableButton(0,1,0,false)
        Assert.assertEquals(false, result)
    }

    @Test
    fun `Caso 04`() {
        val result = signUpUseCase.changeEnableButton(0,1,0,true)
        Assert.assertEquals(false, result)
    }

    @Test
    fun `Caso 05`() {
        val result = signUpUseCase.changeEnableButton(0,1,1,false)
        Assert.assertEquals(false, result)
    }

    @Test
    fun `Caso 06`() {
        val result = signUpUseCase.changeEnableButton(0,1,1,true)
        Assert.assertEquals(false, result)
    }

    @Test
    fun `Caso 07`() {
        val result = signUpUseCase.changeEnableButton(1,1,0,false)
        Assert.assertEquals(false, result)
    }
    ...
    @Test
    fun `Caso 10`() {
        val result = signUpUseCase.changeEnableButton(1,1,1,true)
